...
//        public static IEnumerable<ApplicationUninstallerEntry> GetRelatedUninstallers(
...
namespace BulkCrapUninstaller.Forms
{
    public partial class BeginUninstallTaskWizard : Form
    {
        ...
        {
            PageNumber = Math.Min(tabControl1.TabCount - 1, PageNumber + 1);
            if (PageNumber == tabControl1.TabCount - 1)
            {
                // Đến trang cuối cùng, tự động nhấn nút Button2
        ...
        {
            await Task.Delay(1000); // Giả mạo thời gian thực hiện công việc ở mỗi trang
            ...
            for (int i = 1; i < tabControl1.TabCount; i++)
            {
                ...
                await Task.Delay(1000); // Giả mạo thời gian chuyển trang
                PageNumber = i;
            }
        }
