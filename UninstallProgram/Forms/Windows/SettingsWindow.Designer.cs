...
namespace UninstallProgram.Forms
{
    partial class SettingsWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            propertiesSidebar1 = new Controls.PropertiesSidebar();
            tabPageInterface = new TabPage();
            groupBoxLanguage = new GroupBox();
            tabPageUninstallation = new TabPage();
            uninstallationSettings1 = new Controls.UninstallationSettings();
            ...
            cacheSettings1 = new Controls.Settings.CacheSettings();
            ...
            propertiesSidebar1.OrphansEnabled = true;
            propertiesSidebar1.ProtectedEnabled = true;
            propertiesSidebar1.ShowTweaksEnabled = true;
            propertiesSidebar1.StoreAppsEnabled = true;
            propertiesSidebar1.SysCompEnabled = true;
            propertiesSidebar1.UpdatesEnabled = true;
            propertiesSidebar1.WinFeaturesEnabled = true;
            // 
            // tabPageInterface
            // 
